	soc_system u0 (
		...
		.i2c_0_bus_signals_i2c_scl             (<connected-to-i2c_0_bus_signals_i2c_scl>),             //         i2c_0_bus_signals.i2c_scl
		.i2c_0_bus_signals_i2c_sda             (<connected-to-i2c_0_bus_signals_i2c_sda>),             //                          .i2c_sda
		.i2c_0_bus_signals_i2c_test_out        (<connected-to-i2c_0_bus_signals_i2c_test_out>),        //                          .i2c_test_out
		.i2c_0_debug_address                   (<connected-to-i2c_0_debug_address>),                   //               i2c_0_debug.address
		.i2c_0_debug_chipselect                (<connected-to-i2c_0_debug_chipselect>),                //                          .chipselect
		.i2c_0_debug_read                      (<connected-to-i2c_0_debug_read>),                      //                          .read
		.i2c_0_debug_write                     (<connected-to-i2c_0_debug_write>),                     //                          .write
		.i2c_0_debug_readdata                  (<connected-to-i2c_0_debug_readdata>),                  //                          .readdata
		.i2c_0_debug_writedata                 (<connected-to-i2c_0_debug_writedata>),                 //                          .writedata
